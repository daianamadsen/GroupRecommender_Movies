...
public class TRADGRecPAMahoutTest {
	private static final Logger logger = LogManager.getLogger(TRADGRecPAMahoutTest.class);
	
	private static final String CONFIGS_PATH = "edu/isistan/christian/recommenders/groups/movies/configs/TRADGRecPA_MahoutConfigs.properties";
	
	private static final boolean FORCE_REINITIALIZE = false;
	
	private static final int ITEMS_PER_REC = 10;
	
	private static void makeRecommendation (TRADGRecPAMovies recommender, GRecGroup group, MoviesCSVResultsExporter exporter) throws SURException{
		try {
...
//			exporter.export(result, "C:\\Users\\Christian\\Desktop", true);
	...
	public static void main (String[] args){
		...
		try {
			...
			TRADGRecPAConfigsMoviesMahout mahoutConfigs = new TRADGRecPAConfigsMoviesMahout(CONFIGS_PATH);
			
			TRADGRecPAMovies mahoutGRec = new TRADGRecPAMoviesMahout(mahoutConfigs);
